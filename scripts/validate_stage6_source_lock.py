...
def main() -> None:
    ...
    assert lock["repositories"]["middleware"]["revision"] == "eaf3967ee050a5beb3400ae50fe2ba5fe0ab2a94"
    assert lock["repositories"]["middleware"]["image_digest"] == "sha256:cacf169b00cfd95928d192935592a39bcc759f0da7424531a8ba29e7e36c09f0"
