...
| `appolon1908-hue/Odoo` | `production/api-runtime-completion-20260902` | [58](https://github.com/appolon1908-hue/Odoo/pull/58) | `20ec595d6d94e139e4b2d44253b9f02a16724333` | complete source CI script PASS; staged gitleaks PASS | requested | NOT_DEPLOYED | exact-head CI, approval, merge, isolated migration/restore rehearsal, immutable build, staging/runtime evidence |
| `appolon1908-hue/Codestra-AI` | `production-api-runtime-completion-20260902` | [5](https://github.com/appolon1908-hue/Codestra-AI/pull/5) | `9d141379a9f355c8dbbee56214be4129e9c9f66b` | 10 PASS locally; PostgreSQL exact-head CI pending; gitleaks PASS | fresh automated review requested | NOT_DEPLOYED | exact-head CI/review, merge, immutable build, staging/runtime evidence |
...
| `appolon1908-hue/Codesrea-Social-` | `production-api-runtime-completion-20260902` | [5](https://github.com/appolon1908-hue/Codesrea-Social-/pull/5) | `9479a3bc59bd8f809e052c191fe138f72da4531c` | 10 PASS; gitleaks PASS | fresh automated review requested | NOT_DEPLOYED | exact-head CI/review, merge, immutable build, staging/runtime evidence |
